...
<template>
  <aside
    class="w-72 h-screen bg-white border-r border-gray-100 flex flex-col font-sans"
  >
    <!-- Logo -->
    <div class="px-6 py-5">
    ...
    <div class="px-4 pb-4 space-y-4">
      <!-- Blue Credits Card -->
      <div
        class="bg-gradient-to-br from-blue-600 to-blue-700 rounded-xl p-4 text-center shadow-lg shadow-blue-200"
      >
        <p
          class="text-blue-200 text-[10px] uppercase tracking-wider font-semibold mb-1"
        >
          Credits Left
        </p>
        <p class="text-white text-3xl font-bold mb-3">14</p>
        <button
          class="w-full bg-[#FFCC02] hover:bg-yellow-400 text-gray-900 text-xs font-bold py-2 rounded-full flex items-center justify-center gap-1 transition-colors"
        >
          Top Up
